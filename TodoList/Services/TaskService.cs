...
public class TaskService: ITaskService
{
    ...
    public void Add(string description, int priority)
    {
        ...
        _tasks.Add(new TaskItem(description, priority));
    }
    ...
    public void Edit(int index, string newDescription, int newPriority)
    {
        ...
        var task = tasks[index -1];
        task.Update(newDescription:newDescription, newPriority:newPriority);
    }
